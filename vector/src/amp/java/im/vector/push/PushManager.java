...
public final class PushManager {
    ...
    private static final String DEFAULT_PUSHER_APP_ID = "chat.amp.test.android";
    private static final String DEFAULT_PUSHER_URL = "https://test.amp.chat/_matrix/push/v1/notify";
