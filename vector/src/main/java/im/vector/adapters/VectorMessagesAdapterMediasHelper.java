...
class VectorMessagesAdapterMediasHelper {
    ...
    HashMap<String, ImageView> playImageViews = new HashMap<>();
            ...
            public void onClick(View v) {
                if ((event == playButton.getTag()) && (null != mVectorMessagesAdapterEventsListener)) {
                    ...
                    if ((null != imageView.getTag()) && (imageView.getTag().equals("playing"))) {
                        ...
                        if (!playImageViews.containsKey(mediaUrl)) {
                            playImageViews.put(mediaUrl, imageView);
                        }
    ...
    void refreshPlayImageViews() {
        for (ImageView iv : playImageViews.values()) {
