...
class CaseCreateVitalsDataFragment : CaseCreateDataFragment()  {
    ...
    */
    ...
    private fun initViews() {
        ...
        temperature_time.setOnClickListener {
            showDateTimePicker(CASE_DATA_BODY_TEMPERATURE)
        }

        glucose_time.setOnClickListener {
            showDateTimePicker(CASE_DATA_GLUCOSE)
        }

        oxygen_time.setOnClickListener {
            showDateTimePicker(CASE_DATA_OXYGEN)
        }

        blood_pressure_time.setOnClickListener {
            showDateTimePicker(CASE_DATA_BLOOD_PRESSURE)
        }

        pulse_time.setOnClickListener {
            showDateTimePicker(CASE_DATA_PULSE)
        }
